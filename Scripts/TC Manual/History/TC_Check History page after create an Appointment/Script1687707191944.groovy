...
WebUI.selectOptionByLabel(findTestObject('Object Spy Manual/Appointment/select_Facility'), 'Hongkong CURA Healthcare Center', 
    false)

WebUI.check(findTestObject('Object Spy Manual/Appointment/inpt_hospital_readmission'))

WebUI.verifyElementChecked(findTestObject('Object Spy Manual/Appointment/inpt_hospital_readmission'), 0)

WebUI.check(findTestObject('Object Spy Manual/Appointment/inpt_Medicaid'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementChecked(findTestObject('Object Spy Manual/Appointment/inpt_Medicaid'), 0)
...
WebUI.setText(findTestObject('Object Spy Manual/Appointment/txtarea_Comment'), 'Lorem Ipsum')
...
WebUI.verifyElementPresent(findTestObject('Object Spy Manual/History/btn_History'), 0)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/Profile/btn_Profile'), 0)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/Login/btn_Logout'), 0)

WebUI.click(findTestObject('Object Spy Manual/History/btn_History'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('Object Spy Manual/History/h2_History'), 0)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/History/div_31072023'), 0)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/History/label_Facility'), 0)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/History/label_Apply for hospital readmission'), 0)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/History/label_Healthcare Program'), 0)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/History/label_Comment'), 0)
