...
WebUI.verifyElementPresent(findTestObject('Object Spy Manual/History/p_No appointment'), 0)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/History/btn_Go to Homepage'), 0)

WebUI.click(findTestObject('Object Spy Manual/History/btn_Go to Homepage'), FailureHandling.STOP_ON_FAILURE)
