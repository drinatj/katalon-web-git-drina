...
WebUI.selectOptionByLabel(findTestObject('Object Spy Manual/Appointment/select_Facility'), 'Tokyo CURA Healthcare Center', 
    false)
...
WebUI.verifyElementPresent(findTestObject('Object Spy Manual/Appointment/Calender_July'), 0)
