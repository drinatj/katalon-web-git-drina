...
WebUI.uncheck(findTestObject('Object Spy Manual/Appointment/inpt_hospital_readmission'))

WebUI.verifyElementNotChecked(findTestObject('Object Spy Manual/Appointment/inpt_hospital_readmission'), 0)
...
WebUI.verifyElementNotVisible(findTestObject('Object Spy Manual/Apoointment Confirmation/txt_Comment'), FailureHandling.STOP_ON_FAILURE)
