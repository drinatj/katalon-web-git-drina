...
WebUI.click(findTestObject('Object Spy Manual/Profile/btn_Profile'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('Object Spy Manual/Profile/h2_Profile'), 0)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/Profile/h2_Profile'), 0)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/Profile/btn_Logout Profile'), 0)

WebUI.click(findTestObject('Object Spy Manual/Profile/btn_Logout Profile'), FailureHandling.STOP_ON_FAILURE)
